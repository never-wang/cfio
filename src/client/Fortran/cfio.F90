...
!external cfio_proc_type

interface 
    function cfio_init(x_proc_num, y_proc_num, ratio)
	implicit none
	integer(4), intent(in) :: x_proc_num, y_proc_num, ratio
	integer(4) :: cfio_init
    end function
    function cfio_finalize()
	implicit none
	integer(4) :: cfio_finalize
    end function 
    function cfio_proc_type()
	implicit none
	integer(4) :: cfio_proc_type
    end function
end interface
